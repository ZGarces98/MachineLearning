...
function singleton() {
	 ...
	 * the singleton pattern, let you have a single instance of an object that is persistent an can
	 * be used to control the game. (The singleton pattern is a lot more complex, but I adapted it to 
