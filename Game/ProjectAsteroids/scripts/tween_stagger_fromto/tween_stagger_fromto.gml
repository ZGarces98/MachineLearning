/// @description  tween_stagger_fromto(targets_array, duration, from_vars, to_vars , stagger [,wave_amount=1])
/// @function  tween_stagger_fromto
...
/// @param {Array} from_vars - The special vars array. For more info about the `vars` array see the {@link Animation} documentation.
/// @param {Array} to_vars - The special vars array. For more info about the `vars` array see the {@link Animation} documentation.
