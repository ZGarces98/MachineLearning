/// @function anim_set_yoyo(anim, yoyo);
/// @param {Animation} anim The animation
/// @param {bool} yoyo The value
/// @description 
function anim_set_yoyo(argument0, argument1) {
	/**
	 * Sets the tween's `yoyo` state, where `true` causes the tween to go back and forth, 
	...
	argument0[@ TLANIM.YOYO] = argument1;
